...
public class AsteroidGameFactory implements IAsteroidGameFactory
{
	...
	public BoardComponent MakeSquare()
	{
		...
		GameBoard.Instance().getDestroyer().attach(square);
		return square;
	}
	...
	@Override
	public BoardComponent MakeShield(Square square) {
		Shield shield = new Shield(square);
		GameBoard.Instance().getDestroyer().attach(shield);
		return shield;
	}
